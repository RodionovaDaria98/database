...
namespace gibdd {
    ...
    public partial class autoDataSet : global::System.Data.DataSet {
        ...
        public partial class vodDataTable : global::System.Data.TypedTableBase<vodRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public vodRow AddvodRow(string ИНН, string ФИО, string Адрес) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public vodRow FindByИНН(string ИНН) {
        ...
        public partial class vodRow : global::System.Data.DataRow {
            ...
            public string ИНН {
                get {
                    return ((string)(this[this.tablevod.ИННColumn]));
                }
                set {
                    this[this.tablevod.ИННColumn] = value;
                }
            }
            ...
            public string ФИО {
                get {
                    return ((string)(this[this.tablevod.ФИОColumn]));
                }
                set {
                    this[this.tablevod.ФИОColumn] = value;
                }
            }
            ...
            public string Адрес {
                get {
                    return ((string)(this[this.tablevod.АдресColumn]));
                }
                set {
                    this[this.tablevod.АдресColumn] = value;
                }
            }
        }
...
namespace gibdd.autoDataSetTableAdapters {
    ...
    public partial class vodTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[vod] WHERE (([ИНН] = @Original_ИНН) AND ([ФИО] = @Original_ФИО" +
                "))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[vod] ([ИНН], [ФИО], [Адрес]) VALUES (@ИНН, @ФИО, @Адрес);\r\nSEL" +
                "ECT ИНН, ФИО, Адрес FROM vod WHERE (ИНН = @ИНН)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[vod] SET [ИНН] = @ИНН, [ФИО] = @ФИО, [Адрес] = @Адрес WHERE (([ИНН]" +
                " = @Original_ИНН) AND ([ФИО] = @Original_ФИО));\r\nSELECT ИНН, ФИО, Адрес FROM vod" +
                " WHERE (ИНН = @ИНН)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ИНН, ФИО, Адрес FROM dbo.vod";
        ...
        public virtual int Fill(autoDataSet.vodDataTable dataTable) {
        ...
        public virtual autoDataSet.vodDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            autoDataSet.vodDataTable dataTable = new autoDataSet.vodDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(autoDataSet.vodDataTable dataTable) {
        ...
        public virtual int Delete(string Original_ИНН, string Original_ФИО) {
        ...
        public virtual int Insert(string ИНН, string ФИО, string Адрес) {
            if ((ИНН == null)) {
        ...
        public virtual int Update(string ИНН, string ФИО, string Адрес, string Original_ИНН, string Original_ФИО) {
            if ((ИНН == null)) {
                throw new global::System.ArgumentNullException("ИНН");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ФИО, string Адрес, string Original_ИНН, string Original_ФИО) {
            return this.Update(Original_ИНН, ФИО, Адрес, Original_ИНН, Original_ФИО);
        }
    }
